...
- `(decode|tag|kind|dispatch) (bridge|probe|helper|hop|translator|adapter)` — broader family rule (per 2026-05-09 user ruling): any descriptor of deleted tag-bit dispatch *or deleted kind-blind ABI shapes* that uses bridge/probe/helper/hop/translator/adapter framing belongs to this defection-attractor family and is refused on sight.
