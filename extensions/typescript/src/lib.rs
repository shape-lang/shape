...
pub extern "C" fn shape_language_runtime_vtable() -> *const LanguageRuntimeVTable {
    static VTABLE: LanguageRuntimeVTable = LanguageRuntimeVTable {
        init: Some(runtime::ts_init),
        register_types: Some(runtime::ts_register_types),
        compile: Some(runtime::ts_compile),
        invoke: Some(runtime::ts_invoke),
        dispose_function: Some(runtime::ts_dispose_function),
        language_id: Some(runtime::ts_language_id),
        get_lsp_config: Some(runtime::ts_get_lsp_config),
        free_buffer: Some(runtime::ts_free_buffer),
        drop: Some(runtime::ts_drop),
