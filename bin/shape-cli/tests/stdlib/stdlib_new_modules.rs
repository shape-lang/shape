...
fn eval_with_csv_to_string(code: &str) -> String {
    ...
    match val {
        ...
        serde_json::Value::Object(map) if map.contains_key("String") => {
            match &map["String"] {
...
fn eval_with_csv_to_bool(code: &str) -> bool {
    ...
    match val {
        ...
        serde_json::Value::Object(map) if map.contains_key("Bool") => {
            match &map["Bool"] {
                serde_json::Value::Bool(b) => *b,
...
fn test_csv_parse() {
    init_runtime();
    assert!(eval_with_csv_to_bool(r#"
        use csv
...
fn test_csv_stringify() {
    init_runtime();
    let result = eval_with_csv_to_string(r#"
        use csv
