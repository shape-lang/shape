...
fn test_length_single_char() {
    ShapeTest::new(r#"fn test() -> int { "a".length }
...
fn test_length_with_spaces() {
    ShapeTest::new(r#"fn test() -> int { "hello world".length }
...
#[test]
fn test_trim_spaces() {
    ShapeTest::new(r#"fn test() -> string { "  hello  ".trim() }
...
fn test_trim_only_spaces() {
    ShapeTest::new(r#"fn test() -> string { "   ".trim() }
test()"#).expect_string("");
}
...
#[test]
fn test_trim_start() {
    ShapeTest::new(r#"fn test() -> string { "  hello  ".trimStart() }
test()"#).expect_string("hello  ");
}
...
#[test]
fn test_trim_end() {
    ShapeTest::new(r#"fn test() -> string { "  hello  ".trimEnd() }
test()"#).expect_string("  hello");
}
...
fn test_contains_found() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".contains("world") }
test()"#)
        .expect_bool(true);
}
...
fn test_contains_not_found() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".contains("goodbye") }
test()"#)
        .expect_bool(false);
}
...
fn test_contains_empty_search() {
    ShapeTest::new(r#"fn test() -> bool { "hello".contains("") }
...
fn test_contains_full_match() {
    ShapeTest::new(r#"fn test() -> bool { "hello".contains("hello") }
test()"#).expect_bool(true);
}
...
fn test_contains_single_char() {
    ShapeTest::new(r#"fn test() -> bool { "abcdef".contains("d") }
test()"#).expect_bool(true);
}
...
fn test_contains_at_start() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".contains("hello") }
test()"#)
        .expect_bool(true);
}
...
fn test_replace_single_occurrence() {
    ShapeTest::new(r#"fn test() -> string { "hello world".replace("world", "rust") }
test()"#)
...
fn test_replace_multiple_occurrences() {
    ShapeTest::new(r#"fn test() -> string { "aaa".replace("a", "b") }
test()"#).expect_string("bbb");
}

/// Verifies replace with empty replacement.
#[test]
fn test_replace_with_empty() {
    ShapeTest::new(r#"fn test() -> string { "hello world".replace("world", "") }
test()"#)
        .expect_string("hello ");
}
...
fn test_replace_no_match() {
    ShapeTest::new(r#"fn test() -> string { "hello".replace("xyz", "abc") }
test()"#)
        .expect_string("hello");
}
...
fn test_replace_with_longer() {
    ShapeTest::new(r#"fn test() -> string { "hi".replace("hi", "hello") }
test()"#).expect_string("hello");
}
...
fn test_replace_overlapping() {
    ShapeTest::new(r#"fn test() -> string { "aaaa".replace("aa", "b") }
test()"#).expect_string("bb");
}
...
fn test_substring_with_start_and_end() {
    ShapeTest::new(r#"fn test() -> string { "hello world".substring(0, 5) }
test()"#)
        .expect_string("hello");
}
...
fn test_substring_middle() {
    ShapeTest::new(r#"fn test() -> string { "hello world".substring(6, 11) }
test()"#)
        .expect_string("world");
}
...
fn test_substring_single_char() {
    ShapeTest::new(r#"fn test() -> string { "hello".substring(1, 2) }
test()"#).expect_string("e");
}

/// Verifies substring from start.
#[test]
fn test_substring_from_start() {
    ShapeTest::new(r#"fn test() -> string { "hello".substring(0, 3) }
test()"#).expect_string("hel");
}

/// Verifies substring to end with single arg.
#[test]
fn test_substring_to_end_no_second_arg() {
    ShapeTest::new(r#"fn test() -> string { "hello world".substring(6) }
test()"#)
        .expect_string("world");
}
...
fn test_substring_empty_range() {
    ShapeTest::new(r#"fn test() -> string { "hello".substring(2, 2) }
test()"#).expect_string("");
}
...
fn test_substring_full_string() {
    ShapeTest::new(r#"fn test() -> string { "hello".substring(0, 5) }
test()"#).expect_string("hello");
}
...
fn test_to_uppercase_basic() {
    ShapeTest::new(r#"fn test() -> string { "hello".toUpperCase() }
test()"#).expect_string("HELLO");
}
...
fn test_to_uppercase_mixed() {
    ShapeTest::new(r#"fn test() -> string { "Hello World".toUpperCase() }
test()"#)
...
fn test_to_uppercase_empty() {
    ShapeTest::new(r#"fn test() -> string { "".toUpperCase() }
test()"#).expect_string("");
}
...
fn test_to_lowercase_basic() {
    ShapeTest::new(r#"fn test() -> string { "HELLO".toLowerCase() }
test()"#).expect_string("hello");
}
...
fn test_to_lowercase_mixed() {
    ShapeTest::new(r#"fn test() -> string { "Hello World".toLowerCase() }
test()"#)
        .expect_string("hello world");
}
...
fn test_to_lowercase_with_digits() {
    ShapeTest::new(r#"fn test() -> string { "ABC123".toLowerCase() }
...
fn test_index_of_found() {
    ShapeTest::new(r#"fn test() -> int { "hello world".indexOf("world") }
test()"#)
        .expect_number(6.0);
}
...
fn test_index_of_not_found() {
    ShapeTest::new(r#"fn test() -> int { "hello".indexOf("xyz") }
test()"#).expect_number(-1.0);
}
...
fn test_index_of_at_start() {
    ShapeTest::new(r#"fn test() -> int { "hello".indexOf("hel") }
test()"#).expect_number(0.0);
}
...
fn test_index_of_at_end() {
    ShapeTest::new(r#"fn test() -> int { "hello".indexOf("llo") }
...
fn test_index_of_single_char() {
    ShapeTest::new(r#"fn test() -> int { "abcdef".indexOf("d") }
...
fn test_index_of_empty_string() {
    ShapeTest::new(r#"fn test() -> int { "hello".indexOf("") }
test()"#).expect_number(0.0);
}
...
fn test_index_of_first_occurrence() {
    ShapeTest::new(r#"fn test() -> int { "abcabc".indexOf("bc") }
test()"#).expect_number(1.0);
}
...
fn test_starts_with_true() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".startsWith("hello") }
test()"#)
        .expect_bool(true);
}
...
fn test_starts_with_false() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".startsWith("world") }
test()"#)
        .expect_bool(false);
}
...
fn test_starts_with_empty() {
    ShapeTest::new(r#"fn test() -> bool { "hello".startsWith("") }
test()"#).expect_bool(true);
}
...
fn test_starts_with_full_match() {
    ShapeTest::new(r#"fn test() -> bool { "hello".startsWith("hello") }
test()"#).expect_bool(true);
}
...
fn test_ends_with_true() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".endsWith("world") }
test()"#)
        .expect_bool(true);
}
...
fn test_ends_with_false() {
    ShapeTest::new(r#"fn test() -> bool { "hello world".endsWith("hello") }
test()"#)
        .expect_bool(false);
}
...
fn test_ends_with_empty() {
    ShapeTest::new(r#"fn test() -> bool { "hello".endsWith("") }
test()"#).expect_bool(true);
}
...
fn test_char_at_first() {
    ShapeTest::new(r#"fn test() -> string { "hello".charAt(0) }
test()"#).expect_string("h");
}

/// Verifies charAt at middle position.
#[test]
fn test_char_at_middle() {
    ShapeTest::new(r#"fn test() -> string { "hello".charAt(2) }
test()"#).expect_string("l");
}

/// Verifies charAt at last position.
#[test]
fn test_char_at_last() {
    ShapeTest::new(r#"fn test() -> string { "hello".charAt(4) }
test()"#).expect_string("o");
}

/// Verifies charAt out of bounds returns empty string.
#[test]
fn test_char_at_out_of_bounds() {
    ShapeTest::new(r#"fn test() -> string { "hello".charAt(10) }
test()"#).expect_string("");
}
...
fn test_repeat_basic() {
    ShapeTest::new(r#"fn test() -> string { "ab".repeat(3) }
test()"#).expect_string("ababab");
}

/// Verifies repeat zero times.
#[test]
fn test_repeat_zero() {
    ShapeTest::new(r#"fn test() -> string { "hello".repeat(0) }
test()"#).expect_string("");
}
...
#[test]
fn test_repeat_one() {
    ShapeTest::new(r#"fn test() -> string { "hello".repeat(1) }
test()"#).expect_string("hello");
}
...
fn test_repeat_single_char() {
    ShapeTest::new(r#"fn test() -> string { "x".repeat(5) }
test()"#).expect_string("xxxxx");
}
...
fn test_reverse_basic() {
    ShapeTest::new(r#"fn test() -> string { "hello".reverse() }
test()"#).expect_string("olleh");
}

/// Verifies reverse of palindrome.
#[test]
fn test_reverse_palindrome() {
    ShapeTest::new(r#"fn test() -> string { "racecar".reverse() }
test()"#).expect_string("racecar");
}

/// Verifies reverse of single char.
#[test]
fn test_reverse_single_char() {
    ShapeTest::new(r#"fn test() -> string { "a".reverse() }
...
fn test_reverse_empty() {
    ShapeTest::new(r#"fn test() -> string { "".reverse() }
test()"#).expect_string("");
}
...
fn test_pad_start_basic() {
    ShapeTest::new(r#"fn test() -> string { "42".padStart(5, "0") }
test()"#).expect_string("00042");
}

/// Verifies padStart when no padding needed.
#[test]
fn test_pad_start_no_padding_needed() {
    ShapeTest::new(r#"fn test() -> string { "hello".padStart(3, "x") }
test()"#).expect_string("hello");
}
...
fn test_pad_start_default_space() {
    ShapeTest::new(r#"fn test() -> string { "hi".padStart(5) }
test()"#).expect_string("   hi");
}

/// Verifies basic padEnd.
#[test]
fn test_pad_end_basic() {
    ShapeTest::new(r#"fn test() -> string { "hi".padEnd(5, ".") }
test()"#).expect_string("hi...");
}
...
fn test_pad_end_no_padding_needed() {
    ShapeTest::new(r#"fn test() -> string { "hello".padEnd(3, "x") }
test()"#).expect_string("hello");
}
...
fn test_is_digit_true() {
    ShapeTest::new(r#"fn test() -> bool { "12345".isDigit() }
test()"#).expect_bool(true);
}
...
fn test_is_digit_false() {
    ShapeTest::new(r#"fn test() -> bool { "123a5".isDigit() }
test()"#).expect_bool(false);
}
...
fn test_is_digit_empty() {
    ShapeTest::new(r#"fn test() -> bool { "".isDigit() }
test()"#).expect_bool(false);
}
...
fn test_is_alpha_true() {
    ShapeTest::new(r#"fn test() -> bool { "abcDEF".isAlpha() }
test()"#).expect_bool(true);
}
...
fn test_is_alpha_false() {
    ShapeTest::new(r#"fn test() -> bool { "abc123".isAlpha() }
test()"#).expect_bool(false);
}
...
fn test_is_alpha_empty() {
    ShapeTest::new(r#"fn test() -> bool { "".isAlpha() }
test()"#).expect_bool(false);
}
...
fn test_chain_trim_to_upper() {
    ShapeTest::new(r#"fn test() -> string { "  hello  ".trim().toUpperCase() }
test()"#)
        .expect_string("HELLO");
}
...
fn test_chain_to_lower_contains() {
    ShapeTest::new(r#"fn test() -> bool { "HELLO WORLD".toLowerCase().contains("hello") }
test()"#)
        .expect_bool(true);
}
...
fn test_code_point_at_ascii() {
    ShapeTest::new(r#"fn test() -> int { "A".codePointAt(0) }
...
fn test_to_string_on_string() {
    ShapeTest::new(r#"fn test() -> string { "hello".toString() }
test()"#).expect_string("hello");
}
...
fn test_char_at_after_reverse() {
    ShapeTest::new(r#"fn test() -> string { "abc".reverse().charAt(0) }
test()"#).expect_string("c");
}

/// Verifies repeat then length.
#[test]
fn test_repeat_then_length() {
    ShapeTest::new(r#"fn test() -> int { "ab".repeat(4).length }
test()"#).expect_number(8.0);
}

/// Verifies padStart then length.
#[test]
fn test_pad_start_then_length() {
    ShapeTest::new(r#"fn test() -> int { "hi".padStart(10, "0").length }
...
fn test_pad_end_with_multichar_fill() {
    ShapeTest::new(r#"fn test() -> string { "x".padEnd(5, "ab") }
test()"#).expect_string("xabab");
}

/// Verifies padStart with multi-char fill.
#[test]
fn test_pad_start_with_multichar_fill() {
    ShapeTest::new(r#"fn test() -> string { "x".padStart(5, "ab") }
test()"#).expect_string("ababx");
}
