...
fn test_array_chain_take_last() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].take(3).last() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_chain_drop_first() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].drop(2).first() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_chain_concat_length() {
    ShapeTest::new(r#"function test() { [1, 2].concat([3, 4]).concat([5]).length() }
test()"#)
    .expect_number(5.0);
}
...
fn test_array_chain_slice_reverse() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].slice(1, 4).reverse().first() }
test()"#)
    .expect_number(4.0);
}
...
fn test_array_chain_take_reverse_first() {
    ShapeTest::new(r#"function test() { [10, 20, 30, 40].take(3).reverse().first() }
test()"#)
    .expect_number(30.0);
}
...
fn test_array_length_equality() {
    ShapeTest::new(r#"function test() { [1, 2, 3].length() == 3 }
test()"#)
    .expect_bool(true);
}
...
fn test_array_element_equality() {
    ShapeTest::new(r#"function test() { [10, 20, 30][1] == 20 }
test()"#)
    .expect_bool(true);
}
...
fn test_array_passed_to_function() {
    ShapeTest::new(r#"function sum_arr(arr) {
            var s = 0
            for x in arr {
                s = s + x
            }
...
fn test_array_returned_from_function() {
    ShapeTest::new(r#"function make_arr() { [10, 20, 30] }
...
fn test_array_single_element_operations() {
    ShapeTest::new(r#"function test() { [42].take(1).drop(0).reverse().first() }
test()"#)
    .expect_number(42.0);
}
...
fn test_array_empty_chaining() {
    ShapeTest::new(r#"function test() { [].concat([]).take(0).drop(0).length() }
test()"#)
    .expect_number(0.0);
}
...
fn test_array_take_then_drop() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].take(4).drop(2).length() }
test()"#)
    .expect_number(2.0);
}
...
fn test_array_take_then_drop_values() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].take(4).drop(2).first() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_index_zero() {
    ShapeTest::new(r#"function test() { [99][0] }
test()"#)
    .expect_number(99.0);
}
...
fn test_array_concat_single_element_arrays() {
    ShapeTest::new(r#"function test() { [1].concat([2]).concat([3]).length() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_concat_single_element_arrays_values() {
    ShapeTest::new(r#"function test() { [1].concat([2]).concat([3]).last() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_flatten_preserves_order() {
    ShapeTest::new(r#"function test() { [[3, 4], [1, 2]].flatten().first() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_slice_single_element() {
    ShapeTest::new(r#"function test() { [10, 20, 30].slice(1, 2).first() }
test()"#)
    .expect_number(20.0);
}
...
fn test_array_join_with_space() {
    ShapeTest::new(r#"function test() { ["hello", "world"].join(" ") }
test()"#)
...
fn test_array_of_zero() {
    ShapeTest::new(r#"function test() { [0, 0, 0].length() }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_of_negative_ints() {
    ShapeTest::new(r#"function test() { [-1, -2, -3].first() }
test()"#)
    .expect_number(-1.0);
}
...
fn test_array_of_large_ints() {
    ShapeTest::new(r#"function test() { [1000000, 2000000].first() }
test()"#)
...
fn test_array_contains_none() {
    ShapeTest::new(r#"function test() { [1, 2, 3].includes(None) }
test()"#)
    .expect_bool(false);
}
...
fn test_nested_array_lengths() {
    ShapeTest::new(r#"function test() { [[1, 2, 3], [4, 5]].first().length() }
test()"#)
    .expect_number(3.0);
}
...
fn test_nested_array_inner_first() {
    ShapeTest::new(r#"function test() { [[10, 20], [30, 40]].first().first() }
test()"#)
    .expect_number(10.0);
}
...
fn test_nested_array_inner_last() {
    ShapeTest::new(r#"function test() { [[10, 20], [30, 40]].last().last() }
test()"#)
    .expect_number(40.0);
}
...
fn test_nested_array_flatten_and_index() {
    ShapeTest::new(r#"function test() { [[1, 2], [3, 4]].flatten()[2] }
test()"#)
    .expect_number(3.0);
}
...
fn test_array_let_binding() {
    ShapeTest::new(r#"function test() { let arr = [5, 10, 15]; arr[1] }
test()"#)
    .expect_number(10.0);
}
...
fn test_array_returned_as_value() {
    ShapeTest::new(r#"function test() { [1, 2, 3] }
test().length"#)
    .expect_number(3.0);
}
...
fn test_array_length_after_concat() {
    ShapeTest::new(r#"function test() { let a = [1, 2]; let b = [3, 4, 5]; a.concat(b).length() }
test()"#)
    .expect_number(5.0);
}
...
fn test_array_first_after_drop() {
    ShapeTest::new(r#"function test() { [100, 200, 300, 400].drop(2).first() }
test()"#)
    .expect_number(300.0);
}
...
fn test_array_last_after_take() {
    ShapeTest::new(r#"function test() { [100, 200, 300, 400].take(2).last() }
test()"#)
    .expect_number(200.0);
}
...
fn test_array_reverse_then_take() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].reverse().take(2).last() }
test()"#)
    .expect_number(4.0);
}
...
fn test_array_reverse_then_drop() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].reverse().drop(3).first() }
test()"#)
    .expect_number(2.0);
}
...
fn test_array_slice_then_concat() {
    ShapeTest::new(r#"function test() { [1, 2, 3].slice(0, 2).concat([4, 5]).length() }
test()"#)
    .expect_number(4.0);
}
...
fn test_array_concat_then_flatten() {
    ShapeTest::new(r#"function test() { [[1]].concat([[2]]).flatten().length() }
test()"#)
    .expect_number(2.0);
}
...
fn test_array_includes_after_concat() {
    ShapeTest::new(r#"function test() { [1, 2].concat([3, 4]).includes(3) }
test()"#)
    .expect_bool(true);
}
...
fn test_array_index_of_after_reverse() {
    ShapeTest::new(r#"function test() { [10, 20, 30].reverse().indexOf(10) }
test()"#)
    .expect_number(2.0);
}
...
fn test_array_flatten_then_join() {
    ShapeTest::new(r#"function test() { [[1, 2], [3]].flatten().join("-") }
test()"#)
    .expect_string("1-2-3");
}
...
fn test_array_take_then_join() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].take(3).join(", ") }
test()"#)
    .expect_string("1, 2, 3");
}
...
fn test_array_drop_then_join() {
    ShapeTest::new(r#"function test() { [1, 2, 3, 4, 5].drop(3).join(", ") }
test()"#)
    .expect_string("4, 5");
}
