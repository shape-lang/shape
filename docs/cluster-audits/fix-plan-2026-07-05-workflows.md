...
- **Wave-2 merge plan:** one serialized batch of 6 branches (jit-fallback, wave2/async, wave2/stdlib-serialization, wave2/ffi-rest, wave2/snapshot-resume, wave2/remote-transfer) after 2A/2B/2C/2E land; fold `pb3`+set-key flaky pins in via jit-fallback's known-red edit. Then WF-2F branches from the merged main.
