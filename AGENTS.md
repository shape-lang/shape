...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Phase 1.B-vm (drive shape-vm + shape-jit cascade to 0 errors per ADR-006 §2.7.5) | territory: `crates/shape-vm/src/`, `crates/shape-jit/src/` — KindedSlot/ValueSlot/raw-bits consumer migration | dispatched 2026-05-08 | 2026-05-08 |
