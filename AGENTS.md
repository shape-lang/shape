...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Phase 1.B-vm audit (read-only ground-truth pass per Q3 ruling, post §2.7.5.1) | territory: `crates/shape-vm/src/`, `crates/shape-jit/src/` — KindedSlot/ValueSlot/raw-bits consumer migration | auditing (session 1 surfaced multi-session scope + Q1 ruling needed; Q1 landed as §2.7.5.1; audit dispatched 2026-05-08) | 2026-05-08 |
