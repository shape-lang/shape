...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Wave 2 (JIT compile-time analysis tier — `mir_compiler/{types,v2_call_abi,v2_field,statements,rvalues,mod}.rs`, `osr_compiler.rs`, `executor.rs`, `worker.rs`) | territory: `crates/shape-jit/src/mir_compiler/*` + 4 cohort files | Wave 1 closed `95d52bc` (Δ -22; FrameAnalysisState introduced); Wave 2 dispatched 2026-05-08 | 2026-05-08 |
