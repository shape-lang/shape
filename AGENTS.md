...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Wave 5b (math/array/utility body migration + `pop_builtin_args` runtime — 40 BuiltinFunction variants; 4 stubs to land) | territory: `crates/shape-vm/src/executor/{builtins/{math,array_ops,minimize,object_ops,runtime_delegated,intrinsics/{math,signal,statistical}},vm_impl/builtins}.rs` | Wave 5a `66e7b90` (Δ -57; bounded carrier additions + dispatch slice flip + 29 `todo!` stubs across 5b-5e); cumulative Δ shape-vm 2000→1874, -126; Wave 5b dispatched 2026-05-08 | 2026-05-08 |
