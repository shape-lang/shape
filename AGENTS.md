...
| `bulldozer-strictly-typed-phase-1b` | `../shape-phase-1b` | Phase 1.B migrator | Phase 1.B (caller migration: cascade sites + `typed_object_from_pairs` flip + ValueWord-import cleanup) | territory: `crates/shape-runtime/src/{json_value,wire_conversion,stdlib/json,type_schema/mod,schema_cache,multi_table,multiple_testing,const_eval,intrinsics/matrix,module_bindings,typed_module_exports}.rs`, `crates/shape-vm/src/executor/{typed_object_ops,objects/object_operations,trait_object_ops}.rs` | dispatched 2026-05-08 | 2026-05-08 |
