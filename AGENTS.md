...
| `bulldozer-strictly-typed-phase-1b` | `../shape-phase-1b` | Phase 1.B migrator | Phase 1.B continuation (post §2.7.4 + §2.7.5 ruling — drive shape-runtime to 0 errors) | territory: `crates/shape-runtime/src/` ValueWord callers — see `docs/cluster-audits/phase-1b-valueword-callers.md` for recipe | continuing from `6ae58c4` partial close (57 errors remaining); §2.7.4 + §2.7.5 amendments applied 2026-05-08 | 2026-05-08 |
