...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Wave 5 (Builtin dispatch slice — largest wave per audit, 25+ files; `vm_impl/builtins.rs` + `executor/builtins/*` + `state_builtins/*`; `Vec<ValueWord> → Vec<KindedSlot>`, `ArgVec` typedef → `Vec<KindedSlot>`, `Fn(&[KindedSlot]) → Result<KindedSlot, VMError>`; in-scope: `build_config` `TypedReturn` shape decision + Wave 4 deferred formatter rewrite) | territory: `crates/shape-vm/src/executor/{vm_impl/builtins,builtins/*,state_builtins/*,printing,objects/content_methods}.rs` | Wave 1 `95d52bc`, Wave 2 `9d01005`, Wave 3 `3827bd1`, Wave 4 `4483ba1` (cumulative Δ shape-vm 2000→1931, -69); Wave 5 dispatched 2026-05-08 | 2026-05-08 |
