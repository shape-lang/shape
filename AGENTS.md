...
| `bulldozer-strictly-typed-phase-1b` | `../shape-phase-1b` | Phase 1.B migrator | Phase 1.B re-dispatch (KindedSlot caller migration per ADR-006 §2.7) | territory: `crates/shape-runtime/src/` ValueWord callers — see `docs/cluster-audits/phase-1b-valueword-callers.md` for the per-file recipe | dispatched 2026-05-08 (re-dispatch with §2.7 ruling) | 2026-05-08 |
