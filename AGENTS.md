...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Wave 1 (type_tracking.rs cleanup + verifier alignment) | territory: `crates/shape-vm/src/{type_tracking,bytecode/verifier}.rs` + downstream FrameDescriptor consumers | auditing complete (`docs/cluster-audits/phase-1b-vm-valueword-callers.md`); Wave 1 dispatched 2026-05-08 | 2026-05-08 |
