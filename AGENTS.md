...
| `bulldozer-strictly-typed-phase-1a` | `../shape-phase-1a` | Migrator A | Phase 1.A (ADR-006 foundation refactor) | `crates/shape-value/src/{slot,heap_value,heap_variants,heap_header}.rs` | migrating | 2026-05-08 |
