...
| `bulldozer-strictly-typed-phase-1b-vm` | `../shape-phase-1b-vm` | Phase 1.B-vm consumer migration | Wave 6 (Stack ABI parallel Vec<NativeKind> track per §2.7.7/Q9; WB2.4 retain-on-read via clone_with_kind/drop_with_kind; pop_builtin_args removes Bool transitional sentinel) | territory: `crates/shape-vm/src/executor/{vm_impl/stack,objects/raw_helpers,stack_ops/mod,arithmetic/mod,comparison/mod,logical/mod,loops/mod,call_convention,control_flow/mod}.rs`, `crates/shape-vm/src/bytecode/opcode_defs.rs` | Wave 5b `fa2bafc` surfaced stack-kind gap (Q9 ruling §2.7.7 landed); cumulative Δ shape-vm 2000→1718, -282; Wave 6 dispatched 2026-05-09 | 2026-05-09 |
