...
impl BytecodeCompiler {
    ...
    pub fn new() -> Self {
        Self {
            ...
            local_callable_return_reference_contracts: HashMap::new(),
            module_binding_callable_pass_modes: HashMap::new(),
            module_binding_callable_return_reference_contracts: HashMap::new(),
            function_return_reference_contracts: HashMap::new(),
            current_function_return_reference_contract: None,
            ...
            repeating_body_reference_local_barriers: Vec::new(),
            repeating_body_reference_module_binding_barriers: Vec::new(),
            repeating_body_protected_places: Vec::new(),
            in_call_args: false,
            current_call_arg_borrow_mode: None,
