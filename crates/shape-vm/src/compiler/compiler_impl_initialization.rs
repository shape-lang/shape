...
impl BytecodeCompiler {
    ...
    pub fn new() -> Self {
        Self {
            ...
            directive_reanalysis_program: None,
            directive_reanalysis_known_bindings: Vec::new(),
            directive_signature_overrides: HashMap::new(),
            closure_escape_drop_skip_locals: HashSet::new(),
            closure_binding_capture_drop_locals: HashMap::new(),
            pending_closure_capture_drop_locals: None,
