...
impl VirtualMachine {
    ...
    ///
    /// All operands are typed i32 — the compiler proves this at emission
    /// time, so the kinded pop discards the kind tag (Int32 expected) and
    /// reads the bits as i64 (sign-extended).
