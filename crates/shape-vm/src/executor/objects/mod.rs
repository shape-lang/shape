            ...
            NativeKind::UInt64 => {
                ...
                if let Some(view) = as_v2_typed_array(bits, kind) {
                    let typed = match view.elem_type {
                        ...
                        // ints I8/U8/I16/U16/U32/U64) share the typed-int
                        // method dispatch — methods sum/min/max/etc. operate
                        // on the integer-bit pattern regardless of width;
                        // narrower widths sign-/zero-extend at read time.
                        V2ElemType::I64
                        | V2ElemType::I32
                        | V2ElemType::I8
                        | V2ElemType::U8
