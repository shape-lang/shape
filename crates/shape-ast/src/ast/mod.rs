...
pub use functions::{
    ...
    AnnotationTargetKind, BufferShare, BufferShareRefusal, BufferShareRejection,
    ForeignFunctionDef, FunctionDef, FunctionParameter, NativeAbiBinding,
    UnenforcedEffectRowRejection,
};
